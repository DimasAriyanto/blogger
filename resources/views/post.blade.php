            ...
            <div class="col-md-6">
                <form action="{{ route('post') }}" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" class="query" placeholder="Search.." name="query">
                ...
                <div class="card-body text-center">
                    ...
                    <p>
                        <small class="text-muted">
                            By. <a href="{{ route('userPost', ['user' => $posts[0]->user->username]) }}"
                                class="text-decoration-none">{{ $posts[0]->user->name }}</a> in <a
                                href="{{ route('categoryPost', ['category' => $posts[0]->category->slug]) }}"
